...
c.mainPreConf(textt="BC_CRD",target=c.BC_CRD)
c.mainPreConf(textt="BLUE_BOX_CRD",target=c.BLUE_BOX_CRD)
c.mainPreConf(textt="BROWN_BOX_CRD",target=c.BROWN_BOX_CRD)
c.mainPreConf(textt="OPEN_CRD",target=c.OPEN_CRD)
c.mainPreConf(textt="PURPLE_BOX_CRD",target=c.PURPLE_BOX_CRD)
c.mainPreConf(textt="RA_CRD",target=c.RA_CRD)
c.mainPreConf(textt="TH_CRD",target=c.TH_CRD)
c.mainPreConf(textt="WA_CRD",target=c.WA_CRD)
c.mainPreConf(textt="WARRIOR_CRD",target=c.WARRIOR_CRD)
c.mainPreConf(textt="EX_CRD",target=c.EX_CRD)
