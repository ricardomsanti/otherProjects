...
class Cryptus:
    ...
    def mainConf(self):
        ...
        BC_CRD = self.mainPreConf(self.BC_CRD)
        BLUE_BOX_CRD = self.mainPreConf(self.BLUE_BOX_CRD)
        BROWN_BOX_CRD = self.mainPreConf(self.BROWN_BOX_CRD)
        OPEN_CRD = self.mainPreConf(self.OPEN_CRD)
        PURPLE_BOX_CRD = self.mainPreConf(self.PURPLE_BOX_CRD)
        RA_CRD = self.mainPreConf(self.RA_CRD)
        TH_CRD = self.mainPreConf(self.TH_CRD)
        WA_CRD = self.mainPreConf(self.WA_CRD)
        WARRIOR_CRD = self.mainPreConf(self.WARRIOR_CRD)
        EX_CRD = self.mainPreConf(self.EX_CRD)
        CRD_LIST = self.mainPreConf(self.CRD_LIST)
        activeWindow = self.mainPreConf(self.activeWindow)
