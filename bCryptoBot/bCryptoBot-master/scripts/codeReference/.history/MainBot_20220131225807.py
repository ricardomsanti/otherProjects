...
class Cryptus:
    ...
    def mainConf(self):
        ...
        self.BC_CRD  = input("BOTÃO VERDE SUPERIOR ESQUEDO\n")      
        self.BLUE_BOX_CRD  = input("EXEMPLO BAÚ AZUL\n")      
        self.BROWN_BOX_CRD  = input("EXEMPLO BAÚ MARROM\n")      
        self.OPEN_CRD  = input("EXEMPLO DE SETA QUE ABRE A GAVETA DOS BONECOS", self.OPEN_CRD]
        self.PURPLE_BOX_CRD  = input("EXEMPLO BAÚ ROXO\n")      
        self.RA_CRD  = input("BOTÃO QUE COLOCA TODOS PARA DESCANSAR\n")      
        self.TH_CRD  = input("BOTÃO CENTRAL TREASURE HUNT)", self.TH_CRD]
