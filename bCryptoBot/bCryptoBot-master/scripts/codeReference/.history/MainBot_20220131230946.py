...
class Cryptus:
    ...
    def mainConf(self):
        ...
        print("PARA MARCAR UM ALVO, COLOQUE O CURSOR SOBRE ELE E MANTENHA A TECLA 'C' PRESSIONADA \t ATÉ QUE COMANDO 'OK' APAREÇA")
        print("=====================================================")      
        while keyboard.is_pressed("c") == False:
            while keyboard.is_pressed("g") == True:
                print("BOTÃO VERDE SUPERIOR ESQUEDO\n")
                for x in [3,2,1,"ok"]:
                    print(x)
                    self.BC_CRD  = p.position()      
        #self.BLUE_BOX_CRD  = input("EXEMPLO BAÚ AZUL\n")      
        #self.BROWN_BOX_CRD  = input("EXEMPLO BAÚ MARROM\n")      
        #self.OPEN_CRD  = input("EXEMPLO DE SETA QUE ABRE A GAVETA DOS BONECOS\n")
        #self.PURPLE_BOX_CRD  = input("EXEMPLO BAÚ ROXO\n")      
        #self.RA_CRD  = input("BOTÃO QUE COLOCA TODOS PARA DESCANSAR\n")      
        #self.TH_CRD  = input("BOTÃO CENTRAL TREASURE HUNT\n")
        #self.WA_CRD  = input("BOTÃO QUE COLOCA TODOS PARA TRABALHAR\n")      
        #self.WARRIOR_CRD = input("BOTÃO DO BONECO DE ARMADURA QUE ABRE A JANELA DE CONTROLE\n")      
        #self.EXIT_BUTTON = input("BOTÃO DE SAÍDA\n")      
