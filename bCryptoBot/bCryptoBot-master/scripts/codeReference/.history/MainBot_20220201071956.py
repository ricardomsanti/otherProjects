...
class Cryptus:
    ...
    def mainConf(self):
        ...
        self.BC_CRD = self.mainPreConf(self.BC_CRD)
        self.BLUE_BOX_CRD = self.mainPreConf(self.BLUE_BOX_CRD)
        self.BROWN_BOX_CRD = self.mainPreConf(self.BROWN_BOX_CRD)
        self.OPEN_CRD = self.mainPreConf(self.OPEN_CRD)
        self.PURPLE_BOX_CRD = self.mainPreConf(self.PURPLE_BOX_CRD)
        self.RA_CRD = self.mainPreConf(self.RA_CRD)
        self.TH_CRD = self.mainPreConf(self.TH_CRD)
        self.WA_CRD = self.mainPreConf(self.WA_CRD)
        self.WARRIOR_CRD = self.mainPreConf(self.WARRIOR_CRD)
        self.EX_CRD = self.mainPreConf(self.EX_CRD)
        self.CRD_LIST = self.mainPreConf(self.CRD_LIST)
        self.activeWindow = self.mainPreConf(self.activeWindow)
