...
class Conf:
    ...
    def mainPreConf(self, target=None):
        ...
        record = p.confirm(title="SETUP", text=text ,buttons=["OK", "STOP"])
        position = p.position()
        if record == 'OK':
            for x in [3,2,1,"ok"]:
                t.sleep(0.4)
    ...
    def listConf(self):
        conf_list = []
        conf_list.append(["BC_CRD",self.BC_CRD])
        conf_list.append(["BLUE_BOX_CRD",self.BLUE_BOX_CRD])
        conf_list.append(["BROWN_BOX_CRD",self.BROWN_BOX_CRD])
        conf_list.append(["OPEN_CRD",self.OPEN_CRD])
        conf_list.append(["PURPLE_BOX_CRD",self.PURPLE_BOX_CRD])
        conf_list.append(["RA_CRD",self.RA_CRD])
        conf_list.append(["TH_CRD",self.TH_CRD])
        conf_list.append(["WA_CRD",self.WA_CRD])
        conf_list.append(["WARRIOR_CRD",self.WARRIOR_CRD])
        conf_list.append(["EX_CRD",self.EX_CRD])
        return conf_list
    def mainConf(self):
