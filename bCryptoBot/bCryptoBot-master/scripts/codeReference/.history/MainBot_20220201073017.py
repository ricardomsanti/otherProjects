...
class Cryptus:
    ...
    def mainConf(self):
        ...
        BC_CRD = self.mainPreConf(target=BC_CRD)
        BLUE_BOX_CRD = self.mainPreConf(target=BLUE_BOX_CRD)
        BROWN_BOX_CRD = self.mainPreConf(target=BROWN_BOX_CRD)
        OPEN_CRD = self.mainPreConf(target=OPEN_CRD)
        PURPLE_BOX_CRD = self.mainPreConf(target=PURPLE_BOX_CRD)
        RA_CRD = self.mainPreConf(target=RA_CRD)
        TH_CRD = self.mainPreConf(target=TH_CRD)
        WA_CRD = self.mainPreConf(target=WA_CRD)
        WARRIOR_CRD = self.mainPreConf(target=WARRIOR_CRD)
        EX_CRD = self.mainPreConf(target=EX_CRD)
        CRD_LIST = self.mainPreConf(target=CRD_LIST)
        activeWindow = self.mainPreConf(target=activeWindow)
