...
class Cryptus:
    ...
    def mainConf(self): 
        ...
        EX_CRD = ""
        self.CRD_LIST = [
            ["BOTÃO VERDE SUPERIOR ESQUEDO", BC_CRD]
            ["EXEMPLO BAÚ AZUL", BLUE_BOX_CRD]
            ["EXEMPLO BAÚ MARROM", BROWN_BOX_CRD]
            ["EXEMPLO DE SETA QUE ABRE A GAVETA DOS BONECOS", OPEN_CRD]
            ["EXEMPLO BAÚ ROXO", PURPLE_BOX_CRD]
            ["BOTÃO QUE COLOCA TODOS PARA DESCANSAR", RA_CRD]
            ["BOTÃO CENTRAL TREASURE HUNT", TH_CRD]
            ["BOTÃO QUE COLOCA TODOS PARA TRABALHAR", WA_CRD]
            ["BOTÃO DO BONECO DE ARMADURA QUE ABRE A JANELA DE CONTROLE", WARRIOR_CRD]
            ["BOTÃO DE SAÍDA", EX_CRD]
        ]

        for x in self.CRD_LIST:
            print(x[:][1])
