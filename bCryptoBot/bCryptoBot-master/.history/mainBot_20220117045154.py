...
TUDO COMEÇA "CHAMANDO A CLASSE QUE TEM TODAS AS FERRAMENTA QUE VC VAI PRECISAR"
nv = Navigate()

PRA ABRIR A CAIXA USAMOS O PONTO(.)

O MÉTODO PARA CLICAR EM ALGO PRECISA DE UM PARÃMETRO PARA FUNCIONAR

nv.single_click(....)

AS CORDENADAS ESTÃO SALVAS DENTRO DA CAIXA TAMBÉM
EXEMPLO:

nv.T_HUNT.....coordenadas do botão que abre o tabuleiro
