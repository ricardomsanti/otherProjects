...
f_head = (200,2333)
          ...
          f_head    )
X:  201 Y:  444 RGB: (152,  87,  39)
>>> first_head
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
NameError: name 'first_head' is not defined
>>> p.displayMousePosition()
Press Ctrl-C to quit.
X:  199 Y:  540 RGB: ( 11,   0,   0)
>>> p.displayMousePosition()
Press Ctrl-C to quit.
X:  569 Y:  445 RGB: (141, 144, 141)
>>>
>>>
>>> wbutton
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
NameError: name 'wbutton' is not defined
>>> rest button
  File "<stdin>", line 1
    rest button
         ^
