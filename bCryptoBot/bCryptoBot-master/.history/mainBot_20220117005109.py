...
for x in range(10000):
    print(nv.T_B_BUTTON_LEFT)
    print(p.locateCenterOnScreen("C:\\Users\\QQ\\Google Drive\\CODE_DRIVE\\CRYPTO\\IMG\\targets\\T_B_BUTTON_LEFT.png"))
    p.click(p.locateCenterOnScreen(nv.T_B_BUTTON_LEFT, confidence=0.8))
    print('cliquei')
    x = input("")
