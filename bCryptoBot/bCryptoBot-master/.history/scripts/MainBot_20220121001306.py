...
COORD_YELLOW_BOX = ""                                          
COORD_T_HUNT = (960, 4)              
COORD_REST_BUTTON_ROOT = (675,301)     
COORD_EXIT_BT =  (732,301)
COORD_T_BACK_BUTTON = (345,174)   	                      
COORD_REST_ALL_BUTTON = (676,282)      
COORD_T_OPEN_HERO_CASE_BUTTON = (694,606)                     
COORD_WORK_ALL_BUTTON = (632,276)                     
COORD_WORK_BUTTON_ROOT = (632,306)              
...
IMG_YELLOW_BOX = os.path.join(os.getcwd(), 'yellow_box.png',)
...
static = []
static.append(["BLUE_BOX", COORD_BLUE_BOX, IMG_BLUE_BOX])    
static.append(["BROWN_BOX", COORD_BROWN_BOX, IMG_BROWN_BOX])    
static.append(["PURPLE_BOX", COORD_PURPLE_BOX, IMG_PURPLE_BOX])    
static.append(["YELLOW_BOX", COORD_YELLOW_BOX, IMG_YELLOW_BOX])    
static.append(["T_HUNT", COORD_T_HUNT, IMG_T_HUNT])    
static.append(["REST_BUTTON_ROOT", COORD_REST_BUTTON_ROOT, ""])    
static.append(["EXIT_BT", COORD_EXIT_BT, ""])    
static.append(["T_BACK_BUTTON", COORD_T_BACK_BUTTON, ""])    
static.append(["REST_ALL_BUTTON", COORD_REST_ALL_BUTTON, IMG_REST_ALL_BUTTON])    
static.append(["T_OPEN_HERO_CASE_BUTTON", COORD_T_OPEN_HERO_CASE_BUTTON, IMG_T_OPEN_HERO_CASE_BUTTON])    
static.append(["WORK_ALL_BUTTON", COORD_WORK_ALL_BUTTON, IMG_WORK_ALL_BUTTON])    
static.append(["WORK_BUTTON_ROOT", COORD_WORK_BUTTON_ROOT, ""])    
...
clickList = [ 'COORD_T_OPEN_HERO_CASE_BUTTON',\
...
def clickTime(clickList = [], pauseTime=1):
    for x in clickList:
        p.click(x)
        t.sleel(pauseTime)
clickTime(clickList,1)
