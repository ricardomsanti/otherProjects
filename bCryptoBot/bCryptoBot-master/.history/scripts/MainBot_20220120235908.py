...
static.append(["REST_BUTTON_ROOT", CORD_REST_BUTTON_ROOT, IMG_REST_BUTTON_ROOT])    
static.append(["EXIT_BT", CORD_EXIT_BT, IMG_EXIT_BT])    
static.append(["T_BACK_BUTTON", CORD_T_BACK_BUTTON, IMG_T_BACK_BUTTON])    
...
static.append(["WORK_BUTTON_ROOT", CORD_WORK_BUTTON_ROOT, IMG_WORK_BUTTON_ROOT])    
...
hero_squad = DATA_REF.to_dict()
    ...
    def workAll(self,pause_time=0):
        ...
        #print("T_HUNT")
        t.sleep(pause_time)
        p.click(CO_T_OPEN_HERO_CASE_BUTTON)
        
        print("OPEN_BT")
        t.sleep(pause_time)
        p.click(IMG_T_OPEN_HERO_CASE_BUTTON)
        print("OPEN_BT")
        t.sleep(pause_time)
        p.click(IMG_WORK_ALL_BUTTON)
        print("WORK_ALL")
        t.sleep(pause_time)
        p.click(EXIT_BT)
        print("EXIT")
