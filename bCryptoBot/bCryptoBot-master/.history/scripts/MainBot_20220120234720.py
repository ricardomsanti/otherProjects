...
hero = [ x for x in DATA_REF.where[DATA_REF.Conta == "Ricardo"]]
print(hero)
...
for index, row in DATA_REF.iterrows():
    ...
    Extra_4 =  row['Extra_4']
    Extra_5 =  row['Extra_5']
    CHARGE_CHECK =  row['CHARGE_CHECK']
    TIPO_COMUM =  row['TIPO_COMUM']
    REC =  row['REC/H']
    TOTAL_MIN =  row['TOTAL_MIN']
    TOTAL_HO =  row['TOTAL_HO']
