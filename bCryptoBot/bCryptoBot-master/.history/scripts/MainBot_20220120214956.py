...
#OBSJETOS DINAMICOS
SOURCE_FILE = os.path.join(os.path.join(os.getcwd(), 'FINAL_REFERENCE.xlsx')
#sq = Squad(source_file=SOURCE_FILE, owner_name="Ricardo", tab_name="REFERENCIA_FINAL")
sq = Squad

sq.owner_name=="Ricardo"
