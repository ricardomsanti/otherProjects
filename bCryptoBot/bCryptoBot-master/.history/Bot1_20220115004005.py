...
class Interact:
    def __init__(self):
        ob1 = 
        ob2 = Objects()
        ob1_OPEN_CASE = Objects().get_OPEN_CASE(333,537)
        ob1_get_ALL_WORK_BT= Objects().get_ALL_WORK_BT(279,257)
        ob1_ALL_REST_BT = Objects().get_ALL_REST_BT(318,256)
        ob1_EXIT_BUTTON = Objects().get_EXIT_BUTTON(371,223)
        ob1_GREEN_BT = Objects().get_GREEN_BT(41,170)
        ob1_T_HUNT = Objects().get_T_HUNT(337,347)

        ob2_OPEN_CASE = Objects().get_OPEN_CASE(1017,535)
        ob2_ALL_WORK_BT = Objects().get_ALL_WORK_BT(961,256)
        ob2_ALL_REST_BT = Objects().get_ALL_REST_BT(1001,256)
        ob2_EXIT_BUTTON = Objects().get_EXIT_BUTTON(1055,222)
        ob2_GREEN_BT = Objects().get_GREEN_BT(725,169)
        ob2_T_HUNT = Objects().get_T_HUNT(1020,345)
